...
export const NetworkSection: React.FC = () => {
  ...
  return (
    <section id="network" className="py-24 bg-[#070A0F] text-white font-sans border-b border-slate-800/80 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {networkPillars.map((pillar) => {
            ...
            return (
              <div
                key={pillar.id}
                className="p-6 rounded-3xl bg-[#0B0F17] border border-slate-800 hover:border-slate-600 transition-all space-y-4 relative overflow-hidden group"
              >
                ...
                <h3 className="text-base font-heading font-bold text-white group-hover:text-slate-100 transition-colors">{pillar.title}</h3>
