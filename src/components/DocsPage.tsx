  ...
  const docs = [
    {
      ...
      content: (
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-slate-900">Getting Started with KryonHost</h2>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2 text-xs font-mono">
            ...
            <div className="text-slate-600">2. Configure your hostname and choose your Linux OS distribution</div>
            <div className="text-slate-600">3. Settle payment securely through Cashfree (UPI or Cards)</div>
            <div className="text-emerald-700 font-bold">4. Receive instant IPv4 address, credentials, and white-label panel access</div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-slate-900">Connecting to Your VPS via SSH</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-slate-900">Minecraft Server Setup</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1 font-mono text-xs text-slate-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-slate-900">Network Configuration & Security</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-slate-900">Billing Terms & Renewals</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 pb-4">
          ...
          <span className="text-xs font-mono text-slate-500">Technical Knowledge Base</span>
        </div>
